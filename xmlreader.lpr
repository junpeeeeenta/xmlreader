...
(define-project :name :xmlreader
  :modules (list (make-instance 'module :name "xmlreader.lisp"))
  :projects (list (make-instance 'project-module :name "../line-reader/line-reader"
                                 :show-modules nil))
  :libraries nil
  :editable-files nil
  ...
  :runtime-modules (list :cg.yes-no-string :cg.yes-no-list :cg.wrap-string
                         ...
                         :cg.caret :cg.calendar :cg.button :cg.bitmap-stream
